INSERT INTO SHOPS(NAME, OPEN, MIN_ORDER_AMOUNT, COMMISSION_RATE) VALUES('오겹돼지', true, 13000, 0.01);

INSERT INTO MENUS(SHOP_ID, NAME, PRICE, DESCRIPTION) VALUES(1, '삼겹살 1인세트', 12000, '삼겹살 + 야채세트 + 김치찌개 + 공기밥1개');
